      ...
      return (
          <div style={{ position: "fixed", width: "100%", height: "100%", backgroundColor: "rgba(133, 133, 133, 0.5)", zIndex: "9" }}>
              <div style={{ backgroundColor: "white", opacity: "100%", zIndex: "10", width: "478px", height: "463px", borderRadius: "4px", boxShadow: "0 2px 8px rgba(0,0,0,0.16)", position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)" }}>
                  ...
                  <div style={{ fontSize: "12px", fontWeight: "400", fontFamily: "-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Fira Sans,Droid Sans,Helvetica Neue,sans-serif", padding: "0px 25px 0px" }}>Flashcards are useful for grouping flashcards around a common topic. They can be private or shared.</div>
                  <form action="" method="" style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 25px 0" }}>
                      ...
                      <input style={{ outline: "none", borderRadius: "5px", border: "1px solid #E6E6E6", padding: "0 10px 0", width: "406px", height: "38px", marginLeft: "auto", marginRight: "auto", }} name="deck ID" type="text" placeholder="Flashcard deck ID" onChange={(e) => setDeckId(e.target.value)} /> */}
