...
with app.app_context():
  ...
  demo_user_flashcard_3 = Flashcard(question='What is Docker?', answer="A set of products that use OS-level virtualization to deliver software in packages called containers.", confidence=0, userId=1, deckId=3)
